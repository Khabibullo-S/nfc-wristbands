...
const UserTheme = () => {
    ...
    useEffect(() => {getUser()}, []);
    const listTheme = [
        {theme:'whiteBlack', color1:'#fff', color2:'#000'},
        {theme:'greenBlack', color1:'#7dba28', color2: '#000'},
        {theme:'blackGreen', color1: '#000', color2: '#7dba28'}
    ]
    const listThemeRouter = listTheme.map((item,i)=>{
        ...
        return(<div className="admin__card" style={{background:"none"}}>
            <div className="admin__blanc" style={{padding:0}}>
                ...
                <div className="admin__card-about">
                    <div className="admin__contact-navbar">
                        <div
                            ...
                            className={`${
                                activeNav === "1" ? activeNavCss.activeNav : ""
                            } navbar-btn`}
                        >
                            <span>Contact</span>
                        </div>
                        <div
                            ...
                            className={`${
                                activeNav === "2" ? activeNavCss.activeNav : ""
                            } navbar-btn`}
                        >
                            <span>Company</span>
                        </div>
                        <div
                            ...
                            className={`${
                                activeNav === "3" ? activeNavCss.activeNav : ""
                            } navbar-btn`}
                        >
                            <span>Address</span>
                        </div>
