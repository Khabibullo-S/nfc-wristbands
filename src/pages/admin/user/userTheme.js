                ...
                <div className="theme-box">
                    <div className={`admin__card`} style={{background: "none"}}>
                        <div className="admin__blanc"
                             style={{padding: 0, background: item.color1, color: item.textColor}}>
                    ...
                    {themeApi === item.theme ? <Button className={'themeBtn'} disabled>Active</Button> :
                        <Button className={'themeBtn'} onClick={()=>changeTheme(item.theme)}>Change</Button>}
                </div>
