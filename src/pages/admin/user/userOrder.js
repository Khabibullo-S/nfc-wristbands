...
const UserOrder = () => {
    ...
    const confirmBtn = async () => {
        if (!password) {
            ...
            try {
                ...
                await $authHost.post('api/v1/orders/', { user_id: userDataLogin.user.id });
    ...
    return (
        <div className="user-order-container">
            ...
            <Modal title="Update" visible={updateIsModalOpen} onOk={updateHandleOk} onCancel={updateHandleCancel}>
                <Input
                    placeholder="Enter password"
                    type="password"
                    value={password}
