...
const CompanyUserList = () => {
  ...
  const sendNewUser = async () => {
    if (createUser.username === "" || createUser.username === undefined) {
      ...
      createUser.last_name === undefined
    ) {
      messageApi.open({
        type: "error",
        content: "last_name",
      ...
      createUser.first_name === undefined
    ) {
      messageApi.open({
        type: "error",
        content: "first_name",
  ...
  const sendUpdate = async () => {
    ...
    let dataIndex = {
      ...
      work_info: {
        org: updateUser.work_info
          ? updateUser.work_info.org
          : get.data.work_info.org,
        role: updateUser.work_info
          ? updateUser.work_info.role
          : get.data.work_info.role,
      },
      address: {
        city: updateUser.address.city
          ? get.data.address.city
          : updateUser.address.city,
        street: updateUser.address.street
          ? get.data.address.street
          : updateUser.address.street,
        region: updateUser.address.region
          ? get.data.address.region
          : updateUser.address.region,
        country: updateUser.address.country
          ? get.data.address.country
          : updateUser.address.country,
      },
    };
    if (dataIndex.username === "" || dataIndex.username === undefined) {
      ...
      dataIndex.first_name === undefined
    ) {
      messageApi.open({
        type: "error",
        content: "first_name",
        ...
        <>
          ...
          <Input
            ...
            onChange={(e) => {
              setCreateUser({
                ...createUser,
                work_info: { ...createUser.work_info, org: e.target.value },
              });
            }}
          />
          <Input
            ...
            onChange={(e) => {
              setCreateUser({
                ...createUser,
                work_info: { ...createUser.work_info, role: e.target.value },
              });
            }}
          />
          ...
          <Input
            ...
            onChange={(e) => {
              setCreateUser({
                ...createUser,
                address: { ...createUser.address, city: e.target.value },
              });
            }}
          />
          ...
          <Input
            ...
            onChange={(e) => {
              setCreateUser({
                ...createUser,
                address: { ...createUser.address, street: e.target.value },
              });
            }}
          />
          ...
          <Input
            ...
            onChange={(e) => {
              setCreateUser({
                ...createUser,
                address: { ...createUser.address, region: e.target.value },
              });
            }}
          />
          ...
          <Input
            ...
            onChange={(e) => {
              setCreateUser({
                ...createUser,
                address: { ...createUser.address, country: e.target.value },
              });
            }}
          />
          <button type={"submit"} onClick={sendNewUser}>
            send
          </button>
        </>
      </Modal>
        ...
        <>
          ...
          <Input
            ...
            onChange={(e) => {
              setUpdateUser({
                ...updateUser,
                work_info: { ...updateUser.work_info, org: e.target.value },
              });
            }}
          />
          <Input
            ...
            onChange={(e) => {
              setUpdateUser({
                ...updateUser,
                work_info: { ...updateUser.work_info, role: e.target.value },
              });
            }}
          />
          ...
          <Input
            ...
            onChange={(e) => {
              setUpdateUser({
                ...updateUser,
                address: { ...updateUser.address, street: e.target.value },
              });
            }}
          />
          ...
          <Input
            ...
            onChange={(e) => {
              setUpdateUser({
                ...updateUser,
                address: { ...updateUser.address, region: e.target.value },
              });
            }}
          />
          ...
          <Input
            ...
            onChange={(e) => {
              setUpdateUser({
                ...updateUser,
                address: { ...updateUser.address, country: e.target.value },
              });
            }}
          />
